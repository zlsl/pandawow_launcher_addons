...
local function LoadSkin()
	...
	S:HandleScrollBar2(MountJournalListScrollFrameScrollBar)
	...
	S:HandleScrollBar2(PetJournalListScrollFrameScrollBar)
	...
	local function ColorSelectedPet()
		...
		for i = 1, #petButtons do
			...
			local petID = C_PetJournal_GetPetInfoByIndex(index);
	...
	for i=1, 3 do
        ...
        petButton.levelBG:SetTexture("Interface\\AddOns\\Blizzard_Collections\\petjournalbits.blp");
        petButton.levelBG:SetTexCoord(0.140625, 0.22265625, 0.7265625, 0.7675781);
        petButton.levelBG:SetWidth(21);
        petButton.levelBG:SetHeight(21);
	...
	S:HandleNextPrevButton2(ToyBox.PagingFrame.NextPageButton)
	S:HandleNextPrevButton2(ToyBox.PagingFrame.PrevPageButton)
	...
	S:HandleNextPrevButton2(HeirloomsJournal.PagingFrame.NextPageButton)
	...
	S:HandleNextPrevButton2(WardrobeCollectionFrame.ItemsCollectionFrame.PagingFrame.PrevPageButton, nil, true)
	S:HandleNextPrevButton2(WardrobeCollectionFrame.ItemsCollectionFrame.PagingFrame.NextPageButton)
	...
	for i = 1, 3 do
		for j = 1, 6 do
			...
			hooksecurefunc(WardrobeCollectionFrame.ItemsCollectionFrame["ModelR"..i.."C"..j].Border, 'SetTexture', function(self, texture)
	...
	S:HandleScrollBar2(WardrobeCollectionFrame.SetsCollectionFrame.ScrollFrame.scrollBar)
	...
	S:HandleNextPrevButton2(WardrobeCollectionFrame.SetsTransmogFrame.PagingFrame.NextPageButton)
	S:HandleNextPrevButton2(WardrobeCollectionFrame.SetsTransmogFrame.PagingFrame.PrevPageButton, nil, true)
